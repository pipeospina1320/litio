...
class IdentidicacionTipo extends Fixture
{
    ...
    {
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(11);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(12);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(13);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
...
//        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(14);
//        if (!$arIdentificacionTipo) {
//            $arIdentificacionTipo = new RhuIdentificacionTipo();
...
//            $manager->persist($arIdentificacionTipo);
//        }
//        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(15);
//        if (!$arIdentificacionTipo) {
//            $arIdentificacionTipo = new RhuIdentificacionTipo();
...
//            $manager->persist($arIdentificacionTipo);
//        }
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(21);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(22);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(31);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
...
//        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(33);
//        if (!$arIdentificacionTipo) {
//            $arIdentificacionTipo = new RhuIdentificacionTipo();
...
//            $manager->persist($arIdentificacionTipo);
//        }
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(41);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(42);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(43);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
        ...
        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(44);
        if (!$arIdentificacionTipo) {
            $arIdentificacionTipo = new RhuIdentificacionTipo();
...
//        $arIdentificacionTipo = $manager->getRepository('App\Entity\RecursoHumano\RhuIdentificacionTipo')->find(46);
//        if (!$arIdentificacionTipo) {
//            $arIdentificacionTipo = new RhuIdentificacionTipo();
