...
/**
 * @ORM\Entity(repositoryClass="App\Repository\PeriodoPagoTipoRepository")
 */
class PeriodoPagoTipo
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\GrupoPago", mappedBy="periodoPagoRel")
     */
    protected $centrosCostosPeriodoPagoRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Pago", mappedBy="periodoPagoRel")
     */
