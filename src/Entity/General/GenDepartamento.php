...
class GenDepartamento
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenPais" , inversedBy="departamentoPaisRel")
     * @ORM\JoinColumn(name="codigo_pais_fk" , referencedColumnName="codigo_pais_pk")
     */
    private $paisRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\General\GenCiudad" ,mappedBy="departamentoRel")
     */
