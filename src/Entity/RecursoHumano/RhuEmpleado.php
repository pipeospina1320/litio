...
class RhuEmpleado
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato" , mappedBy="contratoEmpleadoRel")
     */
    private $contratoContratoRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuEmpleadoNumerosContacto" , mappedBy="empleadoNumeroContactoRel")
     */
    protected $numeroContactoRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuPago", mappedBy="empleadoRel")
     */
    protected $pagosEmpleadoRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuProgramacionPagoResumen" , mappedBy="empleadoRel")
     */
    protected $programacionesPagosDetallesEmpleadoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuEmpleadoTipo", inversedBy="empleadoEmpleadoTipoRel")
     * @ORM\JoinColumn(name="codigo_empleado_tipo_fk", referencedColumnName="codigo_empleado_tipo_pk")
     */
    private $empleadoTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuIdentificacionTipo", inversedBy="empleadoIdentificacionRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenCiudad", inversedBy="empleadoCiudadNacimientoRel")
     * @ORM\JoinColumn(name="codigo_ciudad_nacimiento_fk" , referencedColumnName="codigo_ciudad_pk")
     */
    private $ciudadNacimientoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenCiudad", inversedBy="empleadoCiudadExpedicionRel")
     * @ORM\JoinColumn(name="codigo_ciudad_expedicion_fk" , referencedColumnName="codigo_ciudad_pk")
     */
    private $ciudadExpedicionRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuRhTipo" , inversedBy="empleadoRhTipoRel")
     * @ORM\JoinColumn(name="codigo_rh_fk" , referencedColumnName="codigo_rh_tipo_pk")
     */
    private $rhTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuLibretaTipo", inversedBy="empleadoLibretaTipoRel")
     * @ORM\JoinColumn(name="codigo_libreta_tipo_fk" , referencedColumnName="codigo_libreta_tipo_pk")
     */
    private $libretaTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuIdentidadSexo", inversedBy="empleadoIdentidadSexoRel")
     * @ORM\JoinColumn(name="codigo_idenditad_sexo_fk" , referencedColumnName="codigo_identidad_sexo_pk")
     */
    private $identidadSexoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenCuentaBancoTipo" , inversedBy="empleadoCuentaBancoTipoRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenBanco" , inversedBy="empleadoBancoRel")
