...
/**
 * @ORM\Entity(repositoryClass="App\Repository\RecursoHumano\RhuProgramacionPagoResumenRepository")
 */
class RhuProgramacionPagoResumen
{
    /**
     * @ORM\Id
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuProgramacionPago", inversedBy="programacionesPagosResumenRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuEmpleado", inversedBy="programacionesPagosDetallesEmpleadoRel")
     * @ORM\JoinColumn(name="codigo_empleado_fk", referencedColumnName="codigo_empleado_pk")
     */
    protected $empleadoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuContrato", inversedBy="programacionesPagosResumenContratoRel")
