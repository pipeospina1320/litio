...
/**
 * @ORM\Entity(repositoryClass="App\Repository\RecursoHumano\RhuProgramacionPagoRepository")
 */
...
//    private $estadoPagadoBanco = false;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuPagoTipo", inversedBy="programacionesPagosPagoTipoRel")
     * @ORM\JoinColumn(name="codigo_pago_tipo_fk", referencedColumnName="codigo_pago_tipo_pk")
     */
    protected $pagoTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuGrupoPago", inversedBy="programacionesPagosGrupoPagoRel")
     * @ORM\JoinColumn(name="codigo_grupo_pago_fk", referencedColumnName="codigo_grupo_pago_pk")
     */
    protected $grupoPagoRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuProgramacionPagoResumen", mappedBy="programacionPagoRel")
     */
    protected $programacionesPagosResumenRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuPago", mappedBy="programacionPagoRel")
     */
     ...
     * @return mixed
     */
    public function getProgramacionesPagosResumenRel()
    {
        return $this->programacionesPagosResumenRel;
    }

    /**
     * @param mixed $programacionesPagosResumenRel
     */
    public function setProgramacionesPagosResumenRel($programacionesPagosResumenRel): void
    {
        $this->programacionesPagosResumenRel = $programacionesPagosResumenRel;
    }
