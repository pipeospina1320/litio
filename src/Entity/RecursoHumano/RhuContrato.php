...
class RhuContrato
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuPago", mappedBy="contratoRel")
     */
    protected $pagosContratoRel;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuProgramacionPagoResumen", mappedBy="contratoRel")
     */
    protected $programacionesPagosResumenContratoRel;


    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuEmpleado", inversedBy="contratoContratoRel")
     * @ORM\JoinColumn(name="codigo_empleado_fk", referencedColumnName="codigo_empleado_pk")
     */
    private $contratoEmpleadoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuGrupoPago", inversedBy="contratoGrupoPagoRel")
     * @ORM\JoinColumn(name="codigo_grupo_pago_fk", referencedColumnName="codigo_grupo_pago_pk")
     */
    private $grupoPagoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuContratoTipo", inversedBy="contratoContratoTipoRel")
     * @ORM\JoinColumn(name="codigo_contrato_tipo_fk", referencedColumnName="codigo_contrato_tipo_pk")
     */
    private $contratoTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuTiempoLaboradoTipo", inversedBy="contratoTiempoLaboradoTipoRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuSalarioTipo", inversedBy="contratoSalarioTipoRel")
     * @ORM\JoinColumn(name="codigo_salario_tipo_fk", referencedColumnName="codigo_salario_tipo_pk")
     */
    private $salarioTipoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuCargo", inversedBy="contratoCargoRel")
     * @ORM\JoinColumn(name="codigo_cargo_fk", referencedColumnName="codigo_cargo_pk")
     */
    private $cargoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SStipoCotizante", inversedBy="contratoSStipoCotizanteRel")
     * @ORM\JoinColumn(name="codigo_tipo_cotizante_fk", referencedColumnName="codigo_tipo_cotizante_pk")
     */
    private $ssTipoCotizanteRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SSsubTipoContizante", inversedBy="contratoSSsubtipoCotizanteRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SStipoPension", inversedBy="contratoSStipoPensionRel")
     * @ORM\JoinColumn(name="codigo_tipo_pension_fk", referencedColumnName="codigo_tipo_pension_pk")
     */
    private $ssTipoPensionRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SStipoSalud", inversedBy="contratoSStipoSaludRel")
     * @ORM\JoinColumn(name="codigo_tipo_salud_fk", referencedColumnName="codigo_tipo_salud_pk")
     */
    private $ssTipoSaludRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SSclasificacionRiesgo", inversedBy="contratoSSclasificacionRiesgoRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SSentidadPension", inversedBy="contratoEntidadPensionRel")
     * @ORM\JoinColumn(name="codigo_entidad_pension_fk", referencedColumnName="codigo_entidad_pension_pk")
     */
    private $entidadPensionRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SSentidadSalud", inversedBy="contratoEntidadSaludRel")
     * @ORM\JoinColumn(name="codigo_entidad_salud_fk", referencedColumnName="codigo_entidad_salud_pk")
     */
    private $entidadSaludRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SSentidadCesantias", inversedBy="contratoEntidadCesantiasRel")
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\SeguridadSocial\SSentidadCaja", inversedBy="contratoEntidadCajaRel")
     * @ORM\JoinColumn(name="codigo_entidad_caja_fk", referencedColumnName="codigo_entidad_caja_pk")
     */
    private $entidadCajaRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenCiudad", inversedBy="contratoCiudadContratoRel")
     * @ORM\JoinColumn(name="codigo_ciudad_contrato_fk", referencedColumnName="codigo_ciudad_pk")
     */
    private $ciudadContratoRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\General\GenCiudad", inversedBy="contratoCiudadLaboraRel")
     * @ORM\JoinColumn(name="codigo_ciudad_labora_fk", referencedColumnName="codigo_ciudad_pk")
     */
    private $ciudadLaboraRel;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\RecursoHumano\RhuContratoMotivoTerminacion", inversedBy="contratoMotivoTerminacionRel")
     ...
     * @return mixed
     */
    public function getProgramacionesPagosResumenContratoRel()
    {
        return $this->programacionesPagosResumenContratoRel;
    }

    /**
     * @param mixed $programacionesPagosResumenContratoRel
     */
    public function setProgramacionesPagosResumenContratoRel($programacionesPagosResumenContratoRel): void
    {
        $this->programacionesPagosResumenContratoRel = $programacionesPagosResumenContratoRel;
    }
