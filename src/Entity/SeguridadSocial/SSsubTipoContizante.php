...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SeguridadSocial\SSsubTipoContizanteRepository")
 */
class SSsubTipoContizante
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato", mappedBy="ssSubtipoCotizanteRel")
     */
