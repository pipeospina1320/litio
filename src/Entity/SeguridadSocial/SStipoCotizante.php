...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SeguridadSocial\SStipoCotizanteRepository")
 */
class SStipoCotizante
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato", mappedBy="ssTipoCotizanteRel")
     */
