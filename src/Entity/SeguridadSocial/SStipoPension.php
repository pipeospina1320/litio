...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SeguridadSocial\SStipoPensionRepository")
 */
class SStipoPension
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato", mappedBy="ssTipoPensionRel")
     */
