...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SeguridadSocial\SSentidadCesantiasRepository")
 */
class SSentidadCesantias
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato", mappedBy="entidadCesantiasRel")
     */
