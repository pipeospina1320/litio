...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SeguridadSocial\SSentidadCajaRepository")
 */
class SSentidadCaja
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato", mappedBy="entidadCajaRel")
     */
