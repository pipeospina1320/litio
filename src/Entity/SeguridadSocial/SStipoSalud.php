...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SeguridadSocial\SStipoSaludRepository")
 */
class SStipoSalud
{
    /**
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\RecursoHumano\RhuContrato", mappedBy="ssTipoSaludRel")
     */
