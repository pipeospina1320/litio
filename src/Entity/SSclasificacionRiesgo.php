...
/**
 * @ORM\Entity(repositoryClass="App\Repository\SSclasificacionRiesgoRepository")
 */
class SSclasificacionRiesgo
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Contrato", mappedBy="ssClasificacionRiesgoRel")
     */
