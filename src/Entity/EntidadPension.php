...
/**
 * @ORM\Entity(repositoryClass="App\Repository\EntidadPensionRepository")
 */
class EntidadPension
{
    /**
     * @ORM\Id()
     * @ORM\GeneratedValue()
    ...
    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Contrato", mappedBy="entidadPensionRel")
     */
