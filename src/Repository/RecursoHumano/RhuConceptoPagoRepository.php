...
use App\Entity\RecursoHumano\RhuConceptoPago;
 ...
 */
class RhuConceptoPagoRepository extends ServiceEntityRepository
{
    public function __construct(RegistryInterface $registry)
    {
        parent::__construct($registry, RhuConceptoPago::class);
    }
